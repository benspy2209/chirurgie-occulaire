...
const Home: React.FC = () => {
  ...
  const seoTitle = language === 'fr' 
    ? "Dr Remi Dewispelaere | Chirurgien Ophtalmologue Wavre & Bruxelles" 
    : "Dr Remi Dewispelaere | Ophthalmologist Wavre & Brussels";
    
  const seoDesc = language === 'fr'
    ? "Spécialiste en chirurgie de la cataracte et chirurgie vitréo-rétinienne. Consultations à la Clinique Le Verseau (Wavre) et Messidor Eye Center (Uccle)."
    : "Specialist in cataract surgery and vitreo-retinal surgery. Consultations at Clinique Le Verseau (Wavre) and Messidor Eye Center (Uccle).";
  ...
  return (
    <div className="flex flex-col h-full">
      <SEO title={seoTitle} description={seoDesc} isHome={true} />
